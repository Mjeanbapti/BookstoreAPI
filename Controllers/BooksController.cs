...
namespace BookStoreAPI.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public ActionResult<IEnumerable<Book>> UpdateBook([FromForm] int id,  Book book)
        {
        ...
        //https://localhost:44363/api/books/author/jackson
        //https://localhost:44363/api/books/authorname/jackson
        [HttpGet]
        [Route("author/{name}")]
        ...
        //https://localhost:44363/api/books/12/author
        //https://localhost:44363/api/books/authorid/12
        [HttpGet]
        [Route("{id}/author")]
        [Route("authorid/{id}")]
        ...
        //https://localhost:44363/api/books/author/jackson/year/2017
        [HttpGet]
        [Route("author/{author}/year/{year}")]
        public ActionResult<Book> GetBookByAuthorAndYear(string author, int year)
        {
            var book = books.GetBooksByAuthorAndYear(author, year);
            if (book == null)
            {
                return NotFound();
            }
